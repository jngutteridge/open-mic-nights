...
export const openMicData: { events: Event[]; hosts: Host[]; locations: Location[] } = {
  events: [
    ...
    },
    {
      ...
      exceptions: ['2026-01-06', '2026-01-13', '2026-01-20'],
      links: [
        {
          icon: 'facebook',
    ...
    },
    {
      ...
      time: '7pm',
      manualOccurrences: ['2025-11-19', '2025-12-17', '2026-01-21']
    },
    {
      host: 'simon-day',
      location: 'red-cow',
    ...
    },
    {
      ...
      manualOccurrences: ['2025-01-12', '2025-03-09', '2025-06-29']
    },
    {
      ...
      exceptions: ['2025-12-26', '2026-01-30'],
      manualOccurrences: ['2026-01-23']
    },
    {
      hosts: ['fran', 'lucy'],
